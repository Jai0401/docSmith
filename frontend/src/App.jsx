      ...
      <main className={`min-h-[calc(100vh-73px)] transition-all duration-700 ease-in-out ${
        ...
        <div className={`max-w-7xl w-full mx-auto px-4 transition-all duration-700 ease-in-out ${
          ...
          <div className="max-w-3xl mx-auto">
            <h2 className={`text-4xl font-bold mb-6 text-center bg-gradient-to-r from-blue-400 to-teal-400 bg-clip-text text-transparent transition-all duration-700 ease-in-out ${
            ...
            {/* Search Input */}
            <div className={`relative mb-8 group transition-all duration-700 ease-in-out ${
            ...
            {documentation && !loading && (
              <div className="bg-[#161B22] rounded-lg border border-gray-700/50 overflow-hidden shadow-xl transition-all duration-500 ease-in-out animate-fadeIn">
                {/* Results Header */}
